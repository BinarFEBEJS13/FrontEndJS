    ...
    <div className="flex justify-center">
      <div className="flex flex-col justify-center ml-0 sm:ml-4 mt-[4rem] sm:mt-4 w-[23rem] sm:w-[18rem] px-5">
        ...
        <div className="flex flex-col justify-center gap-2 mt-3">
          <div>
            <span className="text-[12px] sm:text-[10px] font-semibold">
          ...
          <div className="mt-[15rem] sm:mt-4">
            <button className="w-full p-3 sm:p-2 bg-[#6148FF] rounded-2xl text-white font-semibold text-[12px] tracking-[1px] shadow-lg shadow-gray-200">
              Ubah Password
            </button>
          </div>
        </div>
