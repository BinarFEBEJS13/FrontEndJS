...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row md:flex-col lg:flex-row">
      ...
      <div
        className={`lg:block ${
          sidebarVisible ? "fixed z-10 w-full  bg-[rgba(0,0,0,0.8)] " : "hidden"
        }`}
      >
      ...
      <div className="w-full">
        ...
        <div className="w-full flex items-center justify-between px-6 sm:px-20 h-[100px] bg-[#EBF3FC]">
          <div className="flex items-center gap-4 w-3/4">
            ...
            />
            <h1 className="text-lg font-bold  sm:text-2xl text-[#6148FF]">
              Hi Admin!
            </h1>
          </div>
          <form action="" className="relative mt-5">
            <input
              type="text"
              placeholder="Cari"
              className="sm pl-5 pr-10 bg-white w-full rounded-2xl h-[4rem] flex items-center"
            />
            <button>
              <img
